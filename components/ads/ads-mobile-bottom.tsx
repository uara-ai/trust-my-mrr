...
export const AdsMobileBottom = ({ ads }: { ads: AdCardData[] }) => {
  ...
  return (
    <section className="fixed bottom-0 left-0 right-0 z-40 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/80 border-t block md:hidden">
